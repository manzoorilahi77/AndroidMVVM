...
import com.gatebot.app.utilities.Alert
import com.gatebot.app.utilities.BottomAlert
import com.gatebot.app.utilities.NetworkUtils
import com.gatebot.app.utilities.toast
...
abstract class BaseActivity<T : ViewDataBinding, V : BaseViewModel<*>> : AppCompatActivity() {
    ...
    fun showQuickAlert(msg: String){
        val bottomAlert = BottomAlert(this)
