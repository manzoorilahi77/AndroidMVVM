...
import com.cleopatra.data.remote.client.InternetConnectionListener
import com.google.gson.GsonBuilder
import com.gatebot.app.BuildConfig
import com.gatebot.app.data.local.Singleton
import com.gatebot.app.data.remote.interfaces.IUsersController
...
class GateBotClientBuilder private constructor() {
    ...
    companion object {
        ...
        private var clientBuilder: GateBotClientBuilder? = null
        ...
        fun getInstance(): GateBotClientBuilder {

            if (clientBuilder == null) {

                clientBuilder = GateBotClientBuilder()
        ...
        fun <A> createApi(apiClass: Class<A>): A? {
            ...
            httpClient.addInterceptor(object : NetworkConnectionInterceptor() {
                        override fun isInternetAvailable(): Boolean {
                            internetConnectionListener?.onInternetConnection(Singleton.isNetworkConnected)
                            return Singleton.isNetworkConnected
                        }
        ...
        interface ServicesApiInterface {
            companion object {
                fun fetchManagers(): IUsersController? = createApi(IUsersController::class.java)
            }
        }
    }
}
